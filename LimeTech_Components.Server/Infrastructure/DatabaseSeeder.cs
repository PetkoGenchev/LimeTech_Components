    ...
    public static class DatabaseSeeder
    {
        public static async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            if (!context.Components.Any())
            {
                ...
                {
                    new Component {Name = "AMD Ryzen 7 9800X3D", Producer = "AMD", TypeOfProduct = "Processor", Price = 1150, PurchasedCount = 10,
                    ...
                    new Component {Name = "AMD Ryzen 7 7700X", Producer = "AMD", TypeOfProduct = "Processor", Price = 690, PurchasedCount = 55,
                    ...
                    new Component {Name = "AMD Ryzen 5 5600X", Producer = "AMD", TypeOfProduct = "Processor", Price = 265, PurchasedCount = 33,
                    ...
                    new Component {Name = "Intel Core i7-14700", Producer = "Intel", TypeOfProduct = "Processor", Price = 750, PurchasedCount = 15,
                    ...
                    new Component {Name = "Intel Core Ultra 7 265K", Producer = "Intel", TypeOfProduct = "Processor", Price = 950, PurchasedCount = 3,
                    ...
                    new Component {Name = "Intel Core Ultra 5 245K", Producer = "Intel", TypeOfProduct = "Processor", Price = 720, PurchasedCount = 21,
                    ...
                    new Component {Name = "MSI MPG B550 Gaming Plus", Producer = "MSI", TypeOfProduct = "Motherboard", Price = 250, PurchasedCount = 15,
                    ...
                    new Component {Name = "ASUS ROG Strix B550-F Gaming WIFI II", Producer = "ASUS", TypeOfProduct = "Motherboard", Price = 420, PurchasedCount = 10,
                    ...
                    new Component {Name = "GIGABYTE B650E AORUS Elite X AX ICE", Producer = "GIGABYTE", TypeOfProduct = "Motherboard", Price = 460, PurchasedCount = 60,
                    ...
                    new Component {Name = "ASUS ROG Strix X670E-E Gaming WIFI", Producer = "ASUS", TypeOfProduct = "Motherboard", Price = 920, PurchasedCount = 5,
                    ...
                    new Component {Name = "MSI MAG Z790 Tomahawk Max WIFI", Producer = "MSI", TypeOfProduct = "Motherboard", Price = 560, PurchasedCount = 18,
                    ...
                    new Component {Name = "ASUS TUF Gaming B760-Plus WIFI", Producer = "ASUS", TypeOfProduct = "Motherboard", Price = 320, PurchasedCount = 44,
                    ...
                    new Component {Name = "ASUS ROG Maximus Z890 Apex", Producer = "ASUS", TypeOfProduct = "Motherboard", Price = 1760, PurchasedCount = 2,
                    ...
                    new Component {Name = "MSI PRO Z890-P WIFI", Producer = "MSI", TypeOfProduct = "Motherboard", Price = 540, PurchasedCount = 11,
                    ...
                    new Component {Name = "Seasonic Prime PX-1600", Producer = "Seasonic", TypeOfProduct = "Power Supply", Price = 780, PurchasedCount = 3,
                    ProductionYear = 2023, PowerUsage = 1600, Status = PartStatus.Available, StockCount = 2, IsPublic = true, BuildId = 5,
                    ImageUrl = "https://localhost:7039/Images/ComponentImages/PRIME-TX-1600-ATX30.jpg"},
                    new Component {Name = "Seasonic Vertex PX-850", Producer = "Seasonic", TypeOfProduct = "Power Supply", Price = 420, PurchasedCount = 15,
                    ProductionYear = 2023, PowerUsage = 850, Status = PartStatus.Available, StockCount = 33, IsPublic = true, BuildId = 5,
                    ImageUrl = "https://localhost:7039/Images/ComponentImages/Vertex-PX-850.jpg"},
                    new Component {Name = "ASUS ROG Loki Platinum ROG-LOKI-1000P", Producer = "ASUS", TypeOfProduct = "Power Supply", Price = 580, PurchasedCount = 6,
                    ProductionYear = 2023, PowerUsage = 1000, Status = PartStatus.Available, StockCount = 3, IsPublic = true, BuildId = 5,
                    ImageUrl = "https://localhost:7039/Images/ComponentImages/ASUSROGLokiPlatinumROG-LOKI.jpg"},
                    new Component {Name = "Corsair SF Series Platinum SF850", Producer = "Corsair", TypeOfProduct = "Power Supply", Price = 430, PurchasedCount = 55,
                    ProductionYear = 2024, PowerUsage = 850, Status = PartStatus.Available, StockCount = 22, IsPublic = true, BuildId = 5,
                    ImageUrl = "https://localhost:7039/Images/ComponentImages/CP-9020256-EU.jpg"},

                    new Component {Name = "G.Skill Trident Z Neo DIMM Kit 16GB F4-3600C", Producer = "G.Skill", TypeOfProduct = "Memory", Price = 125, PurchasedCount = 48,
                    ...
                    new Component {Name = "Corsair Vengeance RGB PRO SL Black DIMM Kit 32GB", Producer = "Corsair", TypeOfProduct = "Memory", Price = 166, PurchasedCount = 32,
                    ...
                    new Component {Name = "G.Skill Ripjaws M5 RGB Black DIMM Kit 32GB", Producer = "G.Skill", TypeOfProduct = "Memory", Price = 270, PurchasedCount = 41,
                    ...
                    new Component {Name = "Corsair Vengeance DIMM Kit 32GB", Producer = "Corsair", TypeOfProduct = "Memory", Price = 230, PurchasedCount = 21,
                    ...
                    new Component {Name = "ASUS Dual GeForce RTX 4060 Ti EVO OC", Producer = "ASUS", TypeOfProduct = "Video Card", Price = 880, PurchasedCount = 15,
                    ...
                    new Component {Name = "MSI GeForce RTX 4070 Ti SUPER 16G GAMING X SLIM", Producer = "MSI", TypeOfProduct = "Video Card", Price = 2000, PurchasedCount = 52,
                    ...
                    new Component {Name = "Sapphire Nitro+ Radeon RX 7900 XT", Producer = "Sapphire", TypeOfProduct = "Video Card", Price = 1643, PurchasedCount = 76,
                    ...
                    new Component {Name = "ASRock Steel Legend Radeon RX 7700 XT OC", Producer = "ASRock", TypeOfProduct = "Video Card", Price = 980, PurchasedCount = 49,
