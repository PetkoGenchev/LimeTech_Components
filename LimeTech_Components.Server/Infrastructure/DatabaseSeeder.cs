        ...
        public static async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            if (!context.Components.Any())
            {
                context.Components.AddRange(new List<Component>
                {
                    ...
                    ProductionYear = 2024, PowerUsage = 120, Status = PartStatus.Available, StockCount = 30, IsPublic = true, BuildId = 7,
                    ...
                    ProductionYear = 2022, PowerUsage = 105, Status = PartStatus.Available, StockCount = 3, IsPublic = true, BuildId = 7,
                    ...
                    ProductionYear = 2020, PowerUsage = 65, Status = PartStatus.Available, StockCount = 5, IsPublic = true, BuildId = 6,
                    ...
                    ProductionYear = 2023, PowerUsage = 65, Status = PartStatus.Available, StockCount = 22, IsPublic = true, BuildId = 8,
                    ...
                    ProductionYear = 2024, PowerUsage = 125, Status = PartStatus.Available, StockCount = 8, IsPublic = true, BuildId = 9,
                    ...
                    ProductionYear = 2024, PowerUsage = 125, Status = PartStatus.Available, StockCount = 11, IsPublic = true, BuildId = 9,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 5, IsPublic = true, BuildId = 6,
                    ...
                    ProductionYear = 2021, PowerUsage = null, Status = PartStatus.Available, StockCount = 10, IsPublic = true, BuildId = 6,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 15, IsPublic = true, BuildId = 7,
                    ...
                    ProductionYear = 2022, PowerUsage = null, Status = PartStatus.Available, StockCount = 30, IsPublic = true, BuildId = 7,
                    ...
                    ProductionYear = 2023, PowerUsage = null, Status = PartStatus.Available, StockCount = 1, IsPublic = true, BuildId = 8,
                    ...
                    ProductionYear = 2023, PowerUsage = null, Status = PartStatus.Available, StockCount = 111, IsPublic = true, BuildId = 8,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 13, IsPublic = true, BuildId = 9,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 4, IsPublic = true, BuildId = 9,
                    ...
                    ProductionYear = 2023, PowerUsage = null, Status = PartStatus.Available, StockCount = 2, IsPublic = true, BuildId = 10,
                    ...
                    ProductionYear = 2023, PowerUsage = null, Status = PartStatus.Available, StockCount = 33, IsPublic = true, BuildId = 10,
                    ...
                    ProductionYear = 2023, PowerUsage = null, Status = PartStatus.Available, StockCount = 3, IsPublic = true, BuildId = 10,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 22, IsPublic = true, BuildId = 10,
                    ...
                    ProductionYear = 2019, PowerUsage = null, Status = PartStatus.Available, StockCount = 22, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/GSkillTridentZNeo3600.jpg"},
                    new Component {Name = "Corsair Vengeance RGB PRO SL Black DIMM Kit 32GB", TypeOfProduct = "Memory", Price = 166, PurchasedCount = 32,
                    ProductionYear = 2021, PowerUsage = null, Status = PartStatus.Available, StockCount = 18, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/CorsairVengeanceRGB32GB.jpg"},
                    new Component {Name = "G.Skill Ripjaws M5 RGB Black DIMM Kit 32GB", TypeOfProduct = "Memory", Price = 270, PurchasedCount = 41,
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 31, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/G.SkillRipjawsM532GB.jpg"},
                    new Component {Name = "Corsair Vengeance DIMM Kit 32GB", TypeOfProduct = "Memory", Price = 230, PurchasedCount = 21,
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 15, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/CorsairVengeance32GB6000.jpg"},

                    new Component {Name = "ASUS Dual GeForce RTX 4060 Ti EVO OC", TypeOfProduct = "Video Card", Price = 880, PurchasedCount = 15,
                    ProductionYear = 2023, PowerUsage = 160, Status = PartStatus.Available, StockCount = 9, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/DUAL-RTX4060TI-O8G-EVO.jpg"},
                    new Component {Name = "MSI GeForce RTX 4070 Ti SUPER 16G GAMING X SLIM", TypeOfProduct = "Video Card", Price = 2000, PurchasedCount = 52,
                    ProductionYear = 2023, PowerUsage = 285, Status = PartStatus.Available, StockCount = 4, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/MSIGeForceRTX4070TiSUPER.jpg"},
                    new Component {Name = "Sapphire Nitro+ Radeon RX 7900 XT", TypeOfProduct = "Video Card", Price = 1643, PurchasedCount = 76,
                    ProductionYear = 2022, PowerUsage = 368, Status = PartStatus.Available, StockCount = 11, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/SapphireNitro+RadeonRX7900XTVapor-X.jpg"},
                    new Component {Name = "ASRock Steel Legend Radeon RX 7700 XT OC", TypeOfProduct = "Video Card", Price = 980, PurchasedCount = 49,
                    ProductionYear = 2023, PowerUsage = 245, Status = PartStatus.Available, StockCount = 1, IsPublic = true, BuildId = 10,
                    ImageUrl = "../Images/ComponentImages/ASRockSteelLegendRadeonRX7700XTOC.jpg"},
