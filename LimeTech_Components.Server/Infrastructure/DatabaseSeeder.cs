        ...
        public static async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            if (!context.Components.Any())
            {
                context.Components.AddRange(new List<Component>
                {
                    ...
                    ProductionYear = 2019, PowerUsage = null, Status = PartStatus.Available, StockCount = 22, IsPublic = true, BuildId = 5,
                    ...
                    ProductionYear = 2021, PowerUsage = null, Status = PartStatus.Available, StockCount = , IsPublic = true, BuildId = 5,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 31, IsPublic = true, BuildId = 5,
                    ...
                    ProductionYear = 2024, PowerUsage = null, Status = PartStatus.Available, StockCount = 15, IsPublic = true, BuildId = 5,
